  ...
  return (
    <section className="section-fade bg-white/80 backdrop-blur-sm rounded-xl shadow-sm p-8 hover:shadow-md transition-all duration-300 hover:bg-white">
      ...
      <div className="space-y-8">
        <div className="hover-lift p-4 rounded-lg bg-gradient-to-br from-white to-gray-50">
          <h3 className="text-xl font-semibold text-secondary mb-4">Informática</h3>
          <ul className="space-y-3">
            {["Microsoft Word", "Windows"].map((skill) => (
              <li key={skill} className="flex items-center text-gray-700 before:content-['•'] before:mr-2 before:text-accent group hover:translate-x-1 transition-transform">
        ...
        <div className="hover-lift p-4 rounded-lg bg-gradient-to-br from-white to-gray-50">
          ...
          <ul className="space-y-3">
            {["Inglês (básico)", "Português (nativo)"].map((language) => (
              <li key={language} className="flex items-center text-gray-700 before:content-['•'] before:mr-2 before:text-accent group hover:translate-x-1 transition-transform">
